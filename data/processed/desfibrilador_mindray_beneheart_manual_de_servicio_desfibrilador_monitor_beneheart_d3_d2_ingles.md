...
**Equipo:** Desfibrilador monitor BeneHeart D3  D2
...
External paddle in-position detection

Multi- parameter module

CPU and power management board

External paddle tray

Therapy connector

50-ohm discharging resistor

Multi- parameter connector panel

External paddles

Self-discharging resistor
...
RJ45 USB Externally extended IO
...
Rear housing assem bly

indicates connection cable. indicates hard connection socket.

High-voltage capacitor

B12 mode selection switch
...
Notes: 1. The D3 recorder is placed on the rear housing while the D6 recorder is placed on the front housing. 2. For D6, the multi-parameter module and the parameter connector panel are connected directly in hard connection mode; for D3, the multi-parameter module and the parameter connector panel are connected through wires. 3. The D6 needs to be connected to an external interface through the D6 interface board.
...
BAT2 Dual-battery management system
...
Keypad boards on left and right electrode pads

Keypad board on front housing
...
AD sampling Overvoltage protection
...
3.3 V, 5 V, and 12 V overvoltage protection 18V
...
Defibrillation charging and discharging

Cable type identification

ASIC

Pace detection High-pass + amplification
...
Keypad identification/lamp

8IO

High voltage portion of defibrillation and pacing

2CH current detection

2CH voltage detection

2CH relay

1 wire

50-ohm self- discharging resistor 2CH relay
...
Keypad board interface Recorder keypad board

Power interface Signal interface Button & indicator interface

Recorder power module Recorder CPU Motor drive circuit
...
```metadata
pagina: 15
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I0.png
contexto: 
```

![Imagen página 15 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I0.png)

Main unit packing

```metadata
pagina: 15
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I1.png
contexto: 
```

![Imagen página 15 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I1.png)

```metadata
pagina: 15
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I2.png
contexto: 
```

![Imagen página 15 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P15_I2.png)
...
430mmHg to + 790 mmHg for CO 2  module (57.3kPa to 105.3kPa)

Storage environment

Storage temperature -30 to 70 ℃ (-20 to 60 ℃  for CO2 module)
...
```metadata
pagina: 21
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P21_I0.png
contexto: 
```

![Imagen página 21 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P21_I0.png)
...
1. Connect the patient simulator to the equipment’s SpO 2  connector.

2. Select the model and manufacturer of the SpO 2  module under test. Configure the parameter as SpO 2

96% and PR 80 bmp.

3. The displayed SpO 2  and PR values should be within the ranges listed below
...
80±3 DS-100A, OXI-A/N, OXI-P/I 96% ±3%
...
```metadata
pagina: 26
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P26_I0.png
contexto: 
```

![Imagen página 26 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P26_I0.png)
...
```metadata
pagina: 27
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P27_I0.png
contexto: 
```

![Imagen página 27 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P27_I0.png)
...
```metadata
pagina: 28
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P28_I0.png
contexto: 
```

![Imagen página 28 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P28_I0.png)
...
4.6.7 CO 2  Module Tests

Leakage Check

1. Access the  [CO2 Setup]  menu and set  [Operating Mode]  to  [Measure].  Wait for CO 2 warm-up.

2. Block the CO 2 module gas inlet completely. This will cause different reactions from the Sidestream

and Microstream CO 2 modules.
...
 Microstream CO 2 module:  [CO2 Purging…] is displayed in 3s. Block the gas inlet for another 30s,
...
For sidestream CO 2  module, zeroing is required before calibration. Enter [ CO2 Setup ] menu and select

[ Zero ] to perform zeroing.

To calibrate the CO 2  module, follow this procedure:

1. Make sure that the CO 2  module has been warmed up or started up.
...
```metadata
pagina: 29
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P29_I0.png
contexto: 
```

![Imagen página 29 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P29_I0.png)

3. Vent the tubing to the CO 2  by opening the gas valve.
...
5. In the  [Maintain CO2]  menu, select a CO 2  value equal to the vented CO 2  concentration.

6. In the  [Calibrate CO2]  menu, the measured CO 2  concentration is displayed. Wait till the measured

CO 2  concentration becomes stable; select [ Calibrate ] to start CO 2  calibrate.

The message [ Calibration Completed! ] is displayed after a successful calibration. If the calibration

failed, the prompt [ Calibration Failed! ] will be displayed. In this case, perform another calibration.
...
```metadata
pagina: 31
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P31_I0.png
contexto: 
```

![Imagen página 31 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P31_I0.png)
...
```metadata
pagina: 31
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P31_I1.png
contexto: 
```

![Imagen página 31 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P31_I1.png)
...
If the reading of “RT Imped” is not correct, replace the therapy module.
...
```metadata
pagina: 32
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P32_I0.png
contexto: 
```

![Imagen página 32 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P32_I0.png)
...
```metadata
pagina: 32
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P32_I1.png
contexto: 
```

![Imagen página 32 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P32_I1.png)
...
The displayed SpO 2  and PR values should be within the specified ranges.
...
Block the gas inlet of the module or watertrap. The CO 2  flowrate is slower
...
The displayed CO 2  value is within 6 ± 0.05 ％ .
...
If the upgrade MPM module is equipped with Masimo SpO 2 , you need to stick a Masimo label at the lower
...
```metadata
pagina: 37
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P37_I0.png
contexto: 
```

![Imagen página 37 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P37_I0.png)

```metadata
pagina: 37
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P37_I1.png
contexto: 
```

![Imagen página 37 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P37_I1.png)
...
If the upgraded MPM module is equipped with Nellcor SpO 2 , you need to stick a Nellcor label at the lower

left corner of the front housing, as indicated in the following pictures.

```metadata
pagina: 38
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P38_I0.png
contexto: 
```

![Imagen página 38 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P38_I0.png)

After upgrade the MPM module, perform the tests described in  4.6.3 ECG Test ,  4.6.4 Resp Test ,  4.6.5 SpO2

Test ,  4.7Electrical Safety Tests , and  4.8 Recorder Check .
...
```metadata
pagina: 39
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P39_I0.png
contexto: 
```

![Imagen página 39 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P39_I0.png)

```metadata
pagina: 39
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P39_I1.png
contexto: 
```

![Imagen página 39 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P39_I1.png)
...
```metadata
pagina: 40
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I0.png
contexto: 
```

![Imagen página 40 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I0.png)
...
```metadata
pagina: 40
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I1.png
contexto: 
```

![Imagen página 40 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I1.png)

4. Enter User Name, Company Name and Serial Number.

```metadata
pagina: 40
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I2.png
contexto: 
```

![Imagen página 40 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P40_I2.png)
...
```metadata
pagina: 41
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I0.png
contexto: 
```

![Imagen página 41 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I0.png)

7. Select Program Folder. Then select  [Next] .

```metadata
pagina: 41
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I1.png
contexto: 
```

![Imagen página 41 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I1.png)

8. Click  [Finish]  to complete installation.

```metadata
pagina: 41
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I2.png
contexto: 
```

![Imagen página 41 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P41_I2.png)
...
```metadata
pagina: 44
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P44_I0.png
contexto: 
```

![Imagen página 44 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P44_I0.png)
...
```metadata
pagina: 44
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P44_I1.png
contexto: 
```

![Imagen página 44 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P44_I1.png)
...
Power supply protection. Refer to  6.6.10 Power Supply Problems .
...
No +3.3 V B output 2. CPU and power management
...
SpO2 Sensor Off The SpO 2  sensor has become detached from

the patient or the module, or there is a fault

with the Sp O 2  sensor, or an unspecified Sp O 2
...
SpO2 Too Much Light There is too much light on the Sp O 2  sensor.
...
SpO2 Low Signal The Sp O 2  signal is too low or too weak. Check
...
SpO2 Interference The Sp O 2  signal has been interfered. Check for
...
SpO2 Board Fault There is a problem with the Sp O 2  measurement
...
there is a leak in the airway. NIBP Air Leak
...
CO2 Zero Failed Check the CO 2  connections. After the sensor’s

temperature becomes stabilized, perform a zero

calibration again.

CO2 Module Error There is a problem with the CO 2  module, or a

problem with the communications between the

host and the CO 2  module. Restart the
...
Function self-test 267 M0 -2V5 power failure
...
```metadata
pagina: 66
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P66_I0.png
contexto: 
```

![Imagen página 66 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P66_I0.png)
...
```metadata
pagina: 66
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P66_I1.png
contexto: 
```

![Imagen página 66 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P66_I1.png)
...
```metadata
pagina: 67
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P67_I0.png
contexto: 
```

![Imagen página 67 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P67_I0.png)
...
```metadata
pagina: 67
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P67_I1.png
contexto: 
```

![Imagen página 67 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P67_I1.png)
...
```metadata
pagina: 68
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I0.png
contexto: 
```

![Imagen página 68 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I0.png)

```metadata
pagina: 68
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I1.png
contexto: 
```

![Imagen página 68 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I1.png)
...
```metadata
pagina: 68
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I2.png
contexto: 
```

![Imagen página 68 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P68_I2.png)
...
```metadata
pagina: 69
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I0.png
contexto: 
```

![Imagen página 69 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I0.png)
...
```metadata
pagina: 69
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I1.png
contexto: 
```

![Imagen página 69 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I1.png)

```metadata
pagina: 69
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I2.png
contexto: 
```

![Imagen página 69 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P69_I2.png)
...
```metadata
pagina: 70
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P70_I0.png
contexto: 
```

![Imagen página 70 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P70_I0.png)
...
```metadata
pagina: 70
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P70_I1.png
contexto: 
```

![Imagen página 70 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P70_I1.png)
...
```metadata
pagina: 71
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I0.png
contexto: 
```

![Imagen página 71 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I0.png)
...
```metadata
pagina: 71
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I1.png
contexto: 
```

![Imagen página 71 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I1.png)

```metadata
pagina: 71
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I2.png
contexto: 
```

![Imagen página 71 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P71_I2.png)
...
```metadata
pagina: 72
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I0.png
contexto: 
```

![Imagen página 72 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I0.png)
...
```metadata
pagina: 72
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I1.png
contexto: 
```

![Imagen página 72 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I1.png)

```metadata
pagina: 72
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I2.png
contexto: 
```

![Imagen página 72 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P72_I2.png)
...
```metadata
pagina: 73
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I0.png
contexto: 
```

![Imagen página 73 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I0.png)
...
```metadata
pagina: 73
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I1.png
contexto: 
```

![Imagen página 73 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I1.png)

2. Pull the therapy port latch upward, and then disconnect the therapy port cable.

```metadata
pagina: 73
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I2.png
contexto: 
```

![Imagen página 73 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P73_I2.png)
...
```metadata
pagina: 74
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I0.png
contexto: 
```

![Imagen página 74 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I0.png)

```metadata
pagina: 74
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I1.png
contexto: 
```

![Imagen página 74 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I1.png)

```metadata
pagina: 74
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I2.png
contexto: 
```

![Imagen página 74 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I2.png)
...
```metadata
pagina: 74
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I3.png
contexto: 
```

![Imagen página 74 - 3](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P74_I3.png)
...
```metadata
pagina: 75
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P75_I0.png
contexto: 
```

![Imagen página 75 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P75_I0.png)
...
```metadata
pagina: 75
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P75_I1.png
contexto: 
```

![Imagen página 75 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P75_I1.png)
...
```metadata
pagina: 76
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P76_I0.png
contexto: 
```

![Imagen página 76 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P76_I0.png)

3. Check that the waterproof strip on the power base is adhered to the proper place.

```metadata
pagina: 76
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P76_I1.png
contexto: 
```

![Imagen página 76 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P76_I1.png)
...
```metadata
pagina: 77
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P77_I0.png
contexto: 
```

![Imagen página 77 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P77_I0.png)
...
```metadata
pagina: 78
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P78_I0.png
contexto: 
```

![Imagen página 78 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P78_I0.png)
...
```metadata
pagina: 78
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P78_I1.png
contexto: 
```

![Imagen página 78 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P78_I1.png)
...
```metadata
pagina: 79
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I0.png
contexto: 
```

![Imagen página 79 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I0.png)

```metadata
pagina: 79
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I1.png
contexto: 
```

![Imagen página 79 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I1.png)
...
```metadata
pagina: 79
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I2.png
contexto: 
```

![Imagen página 79 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P79_I2.png)
...
```metadata
pagina: 80
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I0.png
contexto: 
```

![Imagen página 80 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I0.png)
...
```metadata
pagina: 80
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I1.png
contexto: 
```

![Imagen página 80 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I1.png)

```metadata
pagina: 80
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I2.png
contexto: 
```

![Imagen página 80 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I2.png)

```metadata
pagina: 80
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I3.png
contexto: 
```

![Imagen página 80 - 3](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P80_I3.png)
...
```metadata
pagina: 81
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I0.png
contexto: 
```

![Imagen página 81 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I0.png)

```metadata
pagina: 81
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I1.png
contexto: 
```

![Imagen página 81 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I1.png)
...
```metadata
pagina: 81
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I2.png
contexto: 
```

![Imagen página 81 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P81_I2.png)
...
```metadata
pagina: 82
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I0.png
contexto: 
```

![Imagen página 82 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I0.png)

```metadata
pagina: 82
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I1.png
contexto: 
```

![Imagen página 82 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I1.png)
...
```metadata
pagina: 82
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I2.png
contexto: 
```

![Imagen página 82 - 2](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P82_I2.png)

Recorder drive

board

Snaps Cut this cable if it is there
...
```metadata
pagina: 83
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P83_I0.png
contexto: 
```

![Imagen página 83 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P83_I0.png)

3. Remove the two PT2×6 crosshead tapping screws, and then remove the keypad board.

```metadata
pagina: 83
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P83_I1.png
contexto: 
```

![Imagen página 83 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P83_I1.png)
...
```metadata
pagina: 85
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P85_I0.png
contexto: 
```

![Imagen página 85 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P85_I0.png)
...
```metadata
pagina: 86
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P86_I0.png
contexto: 
```

![Imagen página 86 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P86_I0.png)
...
17 801-0651-00126-00 encoder assembly 1 Include 8 ， 18

801-0651-00043-00 encoder assembly Include 8 ， 18
...
```metadata
pagina: 87
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P87_I0.png
contexto: 
```

![Imagen página 87 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P87_I0.png)
...
10 006-000239-00 IND 1.5mH 5.6 Ω 1 /
...
```metadata
pagina: 89
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P89_I0.png
contexto: 
```

![Imagen página 89 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P89_I0.png)
...
8.6 External Paddles Assembly

8.6.1 Exploded View

```metadata
pagina: 90
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P90_I0.png
contexto: 
```

![Imagen página 90 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P90_I0.png)

8.6.2 Parts List

No. Order Number Part Description Qty Remark

1 115-032394-00 Adult sternum paddle kit 1 /

2 115-032395-00 Adult apex paddle kit 1 /

/ 0651-30-77114 External Paddles 1 Include 1,2
...
1 009-008397-00 New Defi Docking cable 1 /

2 009-006848-00 Defi AC-DC to main control Power cable 1 /

3 115-067299-00      Internal Wire to Defibrillator Socket 1 /

4 009-006840-00 Defi multi_para to main control cable 1 /

5 009-007343-00 Defibrillation Coder Cable 1 /

6 009-006838-00 New Defibrillation LCD cable  tianma D3 1 /

7 009-007721-00 Defibrillation LCD cable Truly (D3) 1 /

8 009-006837-00 Defi before and after the shell cable 1 /

9 1000-21-00122 CABLE GROUND, EQUIPOTENT,T5/T8 1 /

10 M07-00131F--- FUSE Time-lag 250V 3.15AD5X20 1 /

11 115-049460-00 Pace upgrade package 1 /

12 115-049471-00 ECG/Mindray upgrade package 1 /

13 115-049472-00 ECG/Nellcor upgrade package 1 /

14 115-049474-00 ECG/NIBP upgrade package 1 /

15 115-049475-00 ECG/Mindray/NIBP upgrade package 1 /

16 115-049476-00 ECG/Masimo/NIBP upgrade package 1 /

17 115-049477-00 ECG/Nellcor/NIBP upgrade package 1 /

18 115-050533-00 M02D CO2 module upgrade package 1 /

19 115-050532-00 M02D CO2 module upgrade package 1 /

20 115-050531-00 M02D CO2 module upgrade package 1 /

21 115-056520-00 WIFI to 3G Module Package FRU 1 /

22 TR6F-20-67301 Recorder gate (mold MR67301) 1 /

23 A30-000001--- PAPER,THERMAL(50MM X 20M/ROLL) 1 /
...
```metadata
pagina: 94
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P94_I0.png
contexto: 
```

![Imagen página 94 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P94_I0.png)
...
```metadata
pagina: 95
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P95_I0.png
contexto: 
```

![Imagen página 95 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P95_I0.png)
...
```metadata
pagina: 96
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P96_I0.png
contexto: 
```

![Imagen página 96 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P96_I0.png)
...
```metadata
pagina: 97
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P97_I1.png
contexto: 
```

![Imagen página 97 - 1](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P97_I1.png)
...
 For external or internal paddle, the patient leakage current test should be tested when the
...
```metadata
pagina: 99
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P99_I0.png
contexto: 
```

![Imagen página 99 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P99_I0.png)
...
```metadata
pagina: 100
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P100_I0.png
contexto: 
```

![Imagen página 100 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P100_I0.png)
...
jacks. All measurements may have either a true RMS or a DC-only response.
...
```metadata
pagina: 101
imagen: data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P101_I0.png
contexto: 
```

![Imagen página 101 - 0](data/images/desfibrilador_mindray_beneheart_manual_de_servicio_desfibrilador_monitor_beneheart_d3_d2_ingles/P101_I0.png)
...
 For external or internal paddle, the patient auxiliary current test should be tested when the
...
For functional test items, please refer to relevant functional tests in  4 Testing and Maintenance .
...
4 Protective Earth Resistance _____Ω Max 0.1 Ω

5 EARTH Leakage Normal condition(NC) ____μA Max

NC:500μA, SFC:1000μA Single Fault condition(SFC) ____μA

6* Patient Leakage

Current

Normal condition(NC) ____μA Max
...
Note: The test items marked “*” are required only for incoming inspections, after repairs or modifications

that may affect lead leakage [NFPA 99 (2005)8.5.2.1.3].

Deficiency / Note :

Name: ________________________     Date/Signature___________________________
