...
#from rag_engine import get_response ---- se elimina para evitar confusión con la función original sin memoria

# Importamos la función que ya tiene la memoria integrada, que a su vez llama a la función original de rag_engine.py
from test_memoria_completo import get_response_con_memoria_nativa as get_response
app = Flask(__name__)
